            ...
            <div class="accordion" id="accordionStage">
                <div class="accordion-item border border-success my-4  map_area" id="header1">
                    ...
                    <div id="collapseStage-1" class="accordion-collapse collapse <?php if ($projectStage == 1) {
                        ...
                        <div class="accordion-body">
                            ...
                            <div id="stage-1" class="row text-center map-svg d-none" style="max-width: 700px; min-height: 200px;  " >
                                <!-- SVG -->
                ...
                <div class="accordion-item border border-success my-4 map_area" id="header2">
                                ...
                                <table class="table table-sm table-borderless caption-top">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="display-4 fw-bold text-center" id="available-2"><span class="mdi mdi-vanish mdi-spin text-success-emphasis"></td>
                                            <td class="display-4 fw-bold text-center">2024</td>
                                        </tr>
                    ...
                    <div id="collapseStage-2" class="accordion-collapse collapse <?php if ($projectStage == 2) {
                        ...
                        <div class="accordion-body">
                            ...
                            <div id="stage-2" class="row text-center map-svg d-none" >
                            </div>
                            <div class="leyend-status d-flex flex-row justify-content-around text-center fw-bold text-white mt-3">
                                <div class="small bg-sold rounded-pill px-2"><?= lang('Globals.sold') ?></div>
                                <div class="small bg-available rounded-pill px-2"><?= lang('Globals.available') ?></div>
                ...
                <div class="accordion-item border border-success my-4 map_area" id="header3">
                    ...
                    <div id="collapseStage-3" class="accordion-collapse collapse <?php if ($projectStage == 3) {
                        ...
                        <div class="accordion-body">
                            ...
                            <div id="stage-3" class="row text-center map-svg d-none" style="max-width: 1200px; min-height: 200px;  " >
                            </div>
                            <div class="leyend-status d-flex flex-row justify-content-around text-center fw-bold text-white mt-3">
                                <div class="small bg-sold rounded-pill px-2"><?= lang('Globals.sold') ?></div>
                                <div class="small bg-available rounded-pill px-2"><?= lang('Globals.available') ?></div>
                ...
                <div class="accordion-item border border-success my-4 map_area" id="header4">
                    <h2 class="accordion-header border-bottom border-success" id="heading-4">
                        <button class="accordion-button <?php if ($projectStage == 4) {
                                                            echo "";
                                                        } else {
                                                            echo "collapsed";
                                                        } ?>" type="button" data-bs-toggle="collapse" data-bs-target="#collapseStage-4" aria-expanded="false" aria-controls="collapseStage-3" title="Click para ver detalles y mapa">
                            <div class="container table-responsive-md">
                            <table class="table table-sm table-borderless caption-top">
                                    ...
                                    <tbody>
                                        <tr>
                                            <!-- <th class="h2"></th> -->
                                            <td class="display-4 fw-bold text-center">208</td>
                    ...
                    <div id="collapseStage-4" class="accordion-collapse collapse" aria-labelledby="heading-4" data-bs-parent="#accordionExample">
                        <div class="accordion-body">
                            <!-- Price Start -->
                            <div class="container-xxl py-1 px-0">
                                <div class="row g-0 gx-5 align-items-center">
                            ...
                            <!-- <div class="image_map d-none"> -->
                                ...
                                <div  id="stage-4" class="row text-center map-svg d-none" style="max-width: 1300px; min-height: 200px;  ">
                                </div>
                                <div class="leyend-status d-flex flex-row justify-content-around text-center fw-bold text-white mt-3">
                                    <div class="small bg-sold rounded-pill px-2"><?= lang('Globals.sold') ?></div>
                                    <div class="small bg-available rounded-pill px-2"><?= lang('Globals.available') ?></div>
