	...
	<div class="col-lg-4 mb-3">
		...
		<select name="property_characteristic_id[]" class="form-select" id="property_characteristic_id" style="max-height: 38px;" multiple>
			<?php foreach ($getCharacteristics as $characteristic) : ?>
				<option value="<?= $characteristic->property_characteristic_id ?>" <?php if (!empty($formPost) && isset($formPost['property_characteristic_id']) && in_array($characteristic->property_characteristic_id, $formPost['property_characteristic_id'])) echo ' selected'; elseif (!empty($property) && in_array($characteristic->property_characteristic_id, $listPropertyCharacteristics)) echo ' selected'; ?>><?= $characteristic->$propertyCharacteristicNameField ?></option>
			<?php endforeach; ?>
		</select>
