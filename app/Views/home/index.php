	...
	<!-- <div class="container"> -->
		...
		<div class="row g-5 align-items-center" id="image_site">
			<div class="col-lg-6" >
				...
				<div class="row text-center mb-0 pb-0 load-image d-none">
				...
				<div class="about-img position-relative overflow-hidden p-0 pe-0">
	...
	<div class="row row-cols-1 row-cols-lg-3 g-4">
		<div class="col mb-5">
			<div class="card property-item border-5 h-100 shadow">
				<div class="position-relative overflow-hidden text-center">
					<div id="carouselWayuum" class="carousel slide text-center" data-bs-ride="false" data-bs-touch="false" title="Click para ir a la página" data-href=<?= base_url('investments/sorenna?lang='. $lang) ?>>
						<div class="carousel-inner">
							<div class="carousel-item active">
								<img src="<?= STATIC_URL . 'img/sorenna/motivo_de_acceso.jpg' ?>" class="card-img-top img-fluid btn-investments" loading="lazy" width="1754 px" height="1240 px" alt="Desarrollo de Wayúum en Mérida, Yucatán, México.">
							</div>
							<div class="carousel-item">
								<img src="<?= STATIC_URL . 'img/sorenna/vista_area.jpg' ?>" class="card-img-top img-fluid btn-investments" loading="lazy" width="1754 px" height="1240 px" alt="Master Plan Desarrollo de Wayúum Life en Mérida, Yucatán, México.">
							</div>
							<!-- <div class="carousel-item">
						...
						<button class="carousel-control-prev" type="button" data-bs-target="#carouselWayuum" data-bs-slide="prev">
							<span class="carousel-control-prev-icon" aria-hidden="true"></span>
							<span class="visually-hidden"><?= lang('Globals.previous') ?></span>
						</button>
						<button class="carousel-control-next" type="button" data-bs-target="#carouselWayuum" data-bs-slide="next">
							<span class="carousel-control-next-icon" aria-hidden="true"></span>
							<span class="visually-hidden"><?= lang('Globals.next') ?></span>
						</button>
					</div>
				</div>
				<div class="card-body btn-investments" title="Click para ir a la página" data-href=<?= base_url('investments/sorenna?lang='. $lang) ?>>
					<p class="card-text text-center h4" name="project_heading"><?= lang('Globals.header_8') ?></p>
					<p class="card-text text-center h6" name="project_description">Gran Comunidad Residencial ubicada en Chicxulub</p>
				</div>
				<div class="card-footer btn-investments" title="Click para ir a la página" data-href=<?= base_url('investments/sorenna?lang='. $lang) ?>>
		...
		<div class="col mb-5">
			<div class="card property-item border-5 h-100 shadow">
				...
				<div class="card-body btn-investments" title="Click para ir a la página" data-href=<?= base_url('investments/wayuum?lang='. $lang) ?>>
					<p class="card-text text-center h4" name="project_heading"><?= lang('Globals.header_8') ?></p>
					<p class="card-text text-center h6" name="project_description">Gran Comunidad Residencial ubicada en Chicxulub</p>
				</div>
				<div class="card-footer btn-investments" title="Click para ir a la página" data-href=<?= base_url('investments/wayuum?lang='. $lang) ?>>
					<small class="flex-fill text-center text-muted py-2"><span class='mdi mdi-map-marker-outline mdi-18px text-success me-3'></span>Progreso, <?= lang('Globals.homepage_40') ?></small>
				</div>
			</div>
		</div>
			...
			<div class="card property-item border-5 h-100 shadow">
				<div class="position-relative overflow-hidden text-center">
					<div id="carouselLife" class="carousel slide text-center" data-bs-ride="false" data-bs-touch="false" title="Click para ir a la página" data-href=<?= base_url('investments/marela_life?lang='. $lang) ?>>
						<div class="carousel-inner">
							<div class="carousel-item active">
								<img src="<?= STATIC_URL . 'img/marela_life/01-' . $lang . '.jpg' ?>" class="card-img-top img-fluid btn-investments" loading="lazy" width="1754 px" height="1240 px" alt="Desarrollo de Marela Life en Mérida, Yucatán, México.">
							</div>
							<div class="carousel-item">
								<img src="<?= STATIC_URL . 'img/marela_life/07-' . $lang . '.jpg' ?>" class="card-img-top img-fluid btn-investments" loading="lazy" width="1754 px" height="1240 px" alt="Desarrollo de Marela Life en Mérida, Yucatán, México.">
							</div>
							<div class="carousel-item">
								<img src="<?= STATIC_URL . 'img/marela_life/11-' . $lang . '.jpg' ?>" class="card-img-top img-fluid btn-investments" loading="lazy" width="1754 px" height="1240 px" alt="Desarrollo de Marela Life en Mérida, Yucatán, México.">
							</div>
