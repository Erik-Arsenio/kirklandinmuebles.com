...
$routes->get('{locale}/investments/(:any)', 'Projects::index/$1');
...
$routes->get('{locale}/templates/contactForm', 'EmailController::index');
...
$routes->post('{locale}/templates/contactForm', 'EmailController::send',['as'=>'send.email']);
